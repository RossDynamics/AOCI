function polar = cart2m2polar(cart, mu)
%CART2M2POLAR Converts initial conditions in regular, barycentric,
%rotating frame cartesian momentum coordinates (x, y, px, py) to polar
%coordinates (r, theta, rdot, thetadot) centered at the m2 singularity.
